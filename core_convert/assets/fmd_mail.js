document.getElementById('fmd_form').addEventListener('submit', function (event) { // execute this function when the form is submitted
	...
	let link = 'mailto:{__mail__}?subject={__subject__}&body=You need to send this email for your result to count.' // base email link, {__subject__} gets replaced by Py processing
